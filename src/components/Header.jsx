    ...
    return (
        <>
            <div className="w-full h-20 flex justify-between items-center" >
                ...
                <div className="bg-white text-slate-300 w-95 flex items-center rounded-lg  border-solid border-2 border-grey-300">
                    <label className="input input-bordered rounded-md border-0 flex items-center gap-2 h-7 max-w-96 ">
                        ...
                        <input type="text" className="grow text-slate-300 w-96 border-solid border-0 border-blue-500" placeholder="Search" />
                    </label>
                </div>
                ...
                <div className="flex items-center flex-row justify-center">
                    ...
                    <button className="indicator  mr-16">
                        ...
                        <svg viewBox="0 0 512 512" className="h-5 w-5 fill-blue-500" xmlns="http://www.w3.org/2000/svg"><path d="m448 0h-384c-35.3 0-64 28.7-64 64v288c0 35.3 28.7 64 64 64h96v84c0 9.8 11.2 15.5 19.1 9.7l124.9-93.7h144c35.3 0 64-28.7 64-64v-288c0-35.3-28.7-64-64-64z" /></svg>
